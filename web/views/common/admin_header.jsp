  ...
  <nav class="navbar navbar-inverse">
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <div id="logodiv"><a href="/siktam/listMain.ma"><img id="logo" src="/siktam/resources/images/KakaoTalk_20200101_193858750.png" alt="" style="width:50px; height:50px"></a></div>
      </div>
